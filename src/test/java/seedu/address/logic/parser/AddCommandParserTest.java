...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Person expectedPerson = new PersonBuilder(BOB).withTags(VALID_TAG_AC_SERVICE).build();

        // whitespace only preamble
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + NOTES_DESC_BOB + TAG_DESC_AC_SERVICE, new AddCommand(expectedPerson));


        // multiple tags - all accepted
        Person expectedPersonMultipleTags = new PersonBuilder(BOB).withTags(VALID_TAG_AC_SERVICE, VALID_TAG_PLUMBING)
                .build();
        assertParseSuccess(parser,
                NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + NOTES_DESC_BOB
                        + TAG_DESC_PLUMBING + TAG_DESC_AC_SERVICE,
    ...
    public void parse_repeatedNonTagValue_failure() {
        String validExpectedPersonString = NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + NOTES_DESC_BOB + TAG_DESC_AC_SERVICE;
        ...
        // invalid notes
        assertParseFailure(parser, validExpectedPersonString + INVALID_NOTES_DESC,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_NOTES));
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, INVALID_NAME_DESC + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + NOTES_DESC_BOB + TAG_DESC_PLUMBING + TAG_DESC_AC_SERVICE, Name.MESSAGE_CONSTRAINTS);

        // invalid phone
        assertParseFailure(parser, NAME_DESC_BOB + INVALID_PHONE_DESC + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + NOTES_DESC_BOB + TAG_DESC_PLUMBING + TAG_DESC_AC_SERVICE, Phone.MESSAGE_CONSTRAINTS);

        // invalid email
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + INVALID_EMAIL_DESC + ADDRESS_DESC_BOB
                + NOTES_DESC_BOB + TAG_DESC_PLUMBING + TAG_DESC_AC_SERVICE, Email.MESSAGE_CONSTRAINTS);

        // invalid address
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + INVALID_ADDRESS_DESC
                + NOTES_DESC_BOB + TAG_DESC_PLUMBING + TAG_DESC_AC_SERVICE, Address.MESSAGE_CONSTRAINTS);

        // invalid notes
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + INVALID_NOTES_DESC + TAG_DESC_PLUMBING + TAG_DESC_AC_SERVICE, Notes.MESSAGE_CONSTRAINTS);

        // invalid tag
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + NOTES_DESC_BOB + INVALID_TAG_DESC + VALID_TAG_AC_SERVICE, Tag.MESSAGE_CONSTRAINTS);
        ...
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + TAG_DESC_PLUMBING + TAG_DESC_AC_SERVICE,
