...
public class ParserUtilTest {
    ...
    private static final String VALID_NOTES = "Call before arrival";
    private static final String VALID_LOG_MESSAGE = "Observed leakage beneath sink during site visit.";
    ...
    @Test
    public void parseLogMessage_null_throwsNullPointerException() {
        assertThrows(NullPointerException.class, () -> ParserUtil.parseLogMessage(null));
    }

    @Test
    public void parseLogMessage_invalidValue_throwsParseException() {
        assertThrows(ParseException.class, () -> ParserUtil.parseLogMessage(INVALID_LOG_MESSAGE));
    }

    @Test
    public void parseLogMessage_validValueWithoutWhitespace_returnsLogMessage() throws Exception {
        LogMessage expectedLogMessage = new LogMessage(VALID_LOG_MESSAGE);
        assertEquals(expectedLogMessage, ParserUtil.parseLogMessage(VALID_LOG_MESSAGE));
    }

    @Test
    public void parseLogMessage_validValueWithWhitespace_returnsTrimmedLogMessage() throws Exception {
        String logMessageWithWhitespace = WHITESPACE + VALID_LOG_MESSAGE + WHITESPACE;
        LogMessage expectedLogMessage = new LogMessage(VALID_LOG_MESSAGE);
        assertEquals(expectedLogMessage, ParserUtil.parseLogMessage(logMessageWithWhitespace));
    }
